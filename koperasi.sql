...
--
-- Host: 127.0.0.1
-- Generation Time: Jun 17, 2022 at 07:05 AM
...
CREATE TABLE `pinjamans` (
  ...
  `tenor` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL,
  `total_angsuran` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL,
...
INSERT INTO `users` (`id`, `no_anggota`, `nama`, `email`, `password`, `jk`, `pekerjaan`, `alamat`, `no_telp`, `level`, `created_at`, `updated_at`) VALUES
(1, '233', 'Imam', 'ahmadimam@gmail.com', 'sadwda', 'laki-laki', 'petani', 'sadw', '1234123123', '232', '2022-06-14 04:43:04', '2022-06-23 04:43:04');
